...
(:init
    ...
    (= (distance wp8 wp0) 3.76198)
    (= (distance wp0 wp8) 3.76198)
    (= (distance wp8 wp1) 2.6613)
    (= (distance wp1 wp8) 2.6613)
    (= (distance wp8 wp2) 5.27944)
    (= (distance wp2 wp8) 5.27944)
    (= (distance wp8 wp3) 6.52093)
    (= (distance wp3 wp8) 6.52093)
    (= (distance wp8 wp4) 4.92164)
    (= (distance wp4 wp8) 4.92164)
    (= (distance wp8 wp5) 3.34701)
    (= (distance wp5 wp8) 3.34701)
    (= (distance wp8 wp6) 2.84121)
    (= (distance wp6 wp8) 2.84121)
    (= (distance wp8 wp7) 6.20987)
    (= (distance wp7 wp8) 6.20987)
    (= (distance wp8 wp8) 100)
    (= (distance wp9 wp0) 6.33581)
    (= (distance wp0 wp9) 6.33581)
    (= (distance wp9 wp1) 5.32658)
    (= (distance wp1 wp9) 5.32658)
    (= (distance wp9 wp2) 8.57394)
    (= (distance wp2 wp9) 8.57394)
    (= (distance wp9 wp3) 9.82102)
    (= (distance wp3 wp9) 9.82102)
    (= (distance wp9 wp4) 7.45604)
    (= (distance wp4 wp9) 7.45604)
    (= (distance wp9 wp5) 2.37539)
    (= (distance wp5 wp9) 2.37539)
    (= (distance wp9 wp6) 3.41797)
    (= (distance wp6 wp9) 3.41797)
    (= (distance wp9 wp7) 8.22876)
    (= (distance wp7 wp9) 8.22876)
    (= (distance wp9 wp8) 3.5107)
    (= (distance wp8 wp9) 3.5107)
    (= (distance wp9 wp9) 100)
    (= (distance wp10 wp0) 3.80526)
    (= (distance wp0 wp10) 3.80526)
    (= (distance wp10 wp1) 2.7313)
    (= (distance wp1 wp10) 2.7313)
    (= (distance wp10 wp10) 100)
    (= (distance wp10 wp2) 5.37122)
    (= (distance wp2 wp10) 5.37122)
    (= (distance wp10 wp3) 6.62873)
    (= (distance wp3 wp10) 6.62873)
    (= (distance wp10 wp4) 4.998)
    (= (distance wp4 wp10) 4.998)
    (= (distance wp10 wp5) 3.27567)
    (= (distance wp5 wp10) 3.27567)
    (= (distance wp10 wp6) 2.77849)
    (= (distance wp6 wp10) 2.77849)
    (= (distance wp10 wp7) 6.23699)
    (= (distance wp7 wp10) 6.23699)
    (= (distance wp10 wp8) 0.111803)
    (= (distance wp8 wp10) 0.111803)
    (= (distance wp10 wp9) 3.40037)
    (= (distance wp9 wp10) 3.40037)

    (= (speed turtlebot) 0.1)

    (= (min_charge turtlebot) 15)

    (= (state_of_charge turtlebot) 92.6235)

    (= (traveled turtlebot) 7.37652)
